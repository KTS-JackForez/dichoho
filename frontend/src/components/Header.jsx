...
const Header = () => {
  ...
  const data = [
    {
      id: "145",
      img: "https://green.web5phut.com/wp-content/uploads/2022/06/4-300x300.jpg",
      price: "123456",
      sl: "1",
      name: "Rau sạch Đồ Sơn",
    },
    {
      id: "12345",
      img: "https://green.web5phut.com/wp-content/uploads/2022/06/1-300x300.jpg",
      price: "123456",
      sl: "1",
      name: "Che ri Quất Lâm",
    },
  ];
  const hoverOn = () => {
    setOpenCart(true);
