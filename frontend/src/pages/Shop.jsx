  ...
  return (
    <div>
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="bg-cover flex rounded-md mt-2 bg-center bg-no-repeat overflow-hidden text-white h-[50vh] bg-[url('https://cdn.tuoitrethudo.com.vn/stores/news_dataimages/2022/112022/24/15/nhung-dau-an-hp-320221124153448.jpg?rt=20221124153642')]">
          <div className="w-full h-full bg-black/60 flex py-12">
            <div className="w-1/4">
              <img
                src={
                  shopInfo.img ||
