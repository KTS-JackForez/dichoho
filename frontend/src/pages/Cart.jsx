...
const Cart = () => {
  ...
  return (
    <div>
      ...
      <Header />
      <Navbar />
      {/* <div class="max-w-screen-xl mx-auto mt-10 shadow-2xl">
        <div class="flex shadow-md my-10 flex-col md:flex-row">
          <div class="w-3/4 bg-white px-10 py-10">
            <div class="flex justify-between border-b pb-8">
              <h1 class="font-semibold text-2xl uppercase">giỏ hàng</h1>
              <h2 class="font-semibold text-2xl uppercase">tổng: {3}</h2>
            </div>
            <div class="flex mt-10 mb-5 bg-red-400">
            ...
            <div className="divide-primary divide-dashed gap-3 p-3">
              {data.map((i) => {
                return (
                  <div class="flex items-center hover:bg-gray-200 px-6 py-5 ">
          ...
          <div
            id="summary"
            class="w-1/4 px-8 py-10 divide-dashed divide-primary"
          >
            <h1 class="font-semibold text-2xl border-b pb-8 uppercase">
              đơn hàng
            </h1>
            <div class="flex justify-between mt-10 mb-5">
              <span class="font-semibold text-sm uppercase">tiền hàng</span>
